...
* This function will initialize ADC drivers for Seq3 Ch9
* @author Sikender
* @date 2/04/2019
*/
...
* This function will Initialize drivers for ADC with modularity, can configure different channels
* @author Sikender & Sijin
* @param channelNum  Number of channel to initialize 
* @date 2/04/2019
*/
// This initialization function sets up the ADC according to the
// following parameters.  Any parameters not explicitly listed
...
/** ADC0_InitAllTriggerSeq3
* This function will set up ADC according to channel number
* @author Sikender & Sijin
* @param  channelNum  channel number to initiate
* @date 2/04/2019
*/
// This initialization function sets up the ADC according to the
// following parameters.  Any parameters not explicitly listed
...
/**
* This function will collect ADC sample from ADC sequencer 3
* @author Sikender & Sijin
* @return ADC value
* @date 2/04/2019
*/
