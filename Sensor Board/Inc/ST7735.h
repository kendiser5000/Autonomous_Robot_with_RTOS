/**
* @file ST7735.h
* @brief Graphics Driver for ST7735
*
* @author Valvano
*
* @date 2/04/2019
...
//*************************************************************************
// The following protoypes are functions that were modified / added by
// Sikender Ashraf and Sijin Woo
//*************************************************************************

#include "OS.h"

//#define DISPLAY_ZERO		1		// Change this to anything except for 1 to allow
														// zeroes to be displayed
													

/** ST7735_Message
 * The following function separates the display into two screens, a top and
 * and bottom half. There will be 4 lines in each half of the screen where
 * a string can be written.
 * @param device specifies top or bottom
 * @param line specifies the line number (0 to 3)
...
//*************************************************************************
// The following protoypes are functions that were provided in the original
// ST7735 files.
//*************************************************************************
