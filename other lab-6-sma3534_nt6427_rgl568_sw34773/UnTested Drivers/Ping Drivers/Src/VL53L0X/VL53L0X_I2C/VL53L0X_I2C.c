 ...
 */
void VL53L0X_I2C_Init(uint32_t port) {
	switch(port){
		case 0:
 ...
 */
int VL53L0X_read_multi(uint32_t port, uint8_t deviceAddress, uint8_t index, uint8_t* pdata, uint32_t count) {
	...
	switch(port){
		...
		case 0:
			...
			retValue = (I2C0_MCS_R & (I2C_MCS_DATACK|I2C_MCS_ADRACK|I2C_MCS_ERROR));
			break;
		...
		case 1:
			...
			retValue = (I2C1_MCS_R & (I2C_MCS_DATACK|I2C_MCS_ADRACK|I2C_MCS_ERROR));
			break;
		...
		case 2:
			...
			retValue = (I2C2_MCS_R & (I2C_MCS_DATACK|I2C_MCS_ADRACK|I2C_MCS_ERROR));
			break;
		...
		case 3:
			...
			retValue = (I2C3_MCS_R & (I2C_MCS_DATACK|I2C_MCS_ADRACK|I2C_MCS_ERROR));
			break;
 ...
 */
int VL53L0X_read_byte(uint32_t port, uint8_t deviceAddress, uint8_t index, uint8_t *data) {
    // read 1 byte
    return VL53L0X_read_multi(port, deviceAddress, index, data, 1);
}
 ...
 */
int VL53L0X_write_byte(uint32_t port, uint8_t deviceAddress, uint8_t index, uint8_t data) {
    // write 1 byte
    return VL53L0X_write_multi(port, deviceAddress, index, &data, 1);
}
 ...
 */
int VL53L0X_read_word(uint32_t port, uint8_t deviceAddress, uint8_t index, uint16_t *data) {
    // buffer to hold read data
    uint8_t buffer[2];
    // read 2 bytes
    int result = VL53L0X_read_multi(port, deviceAddress, index, buffer, 2);
    // store read data
 ...
 */
int VL53L0X_write_word(uint32_t port, uint8_t deviceAddress, uint8_t index, uint16_t data) {
    // buffer to hold read data
    uint8_t buffer[2];
    ...
    buffer[0] = data >> 8;
    // write 2 bytes
    return VL53L0X_write_multi(port, deviceAddress, index, buffer, 2);
}
 ...
 */
int VL53L0X_read_dword(uint32_t port, uint8_t deviceAddress, uint8_t index, uint32_t *data) {
    // buffer to hold read data
    uint8_t buffer[4];
    // read 4 bytes
    int result = VL53L0X_read_multi(port, deviceAddress, index, buffer, 4);
    // srore read data
 ...
 */
int VL53L0X_write_dword(uint32_t port, uint8_t deviceAddress, uint8_t index, uint32_t data) {
    // buffer to hold read data
    uint8_t buffer[4];
    // put data into buffer
    buffer[0] = data >> 24;
    ...
    buffer[3] = data & 0xFF;
    // write 4 bytes
    return VL53L0X_write_multi(port, deviceAddress, index, buffer, 4);
}
